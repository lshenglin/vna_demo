function extVNAdata_cal(fname, vnaCfg, antCfg, pkCfg, Nup, Npath, mode, ang_val, valid_range)
...
[hEst_t, hEst_f, delay, PDP, ang, fs] = chanEstVNA_cal(fname, pkCfg, Nup, mode, ang_val);
...
if strcmpi(mode, 'csv')
    ...
    for idx = 1:Nrx
        for lp2 = 1 : Npath
            ...
            plot(ang, fftshift(antCfg.c/fs*delay(:, lp2, idx)));
